...
from helper_functions import encode_pdf, text_wrap
import json
from models.llm_deepseek_r1 import LLM
# sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), 
                                            #  '/root/UIST2025/Ex-ChatBI/backend/helper_functions')))
...
class CRAG:
    ...
    def __init__(self, path, model="deepseek", max_tokens=1000, temperature=0, lower_threshold=0.3,
                 upper_threshold=0.7):
        """
        ...
        self.llm = ChatOpenAI(model="deepseek/deepseek-r1:free", 
                              base_url="https://openrouter.ai/api/v1",
                              api_key="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")
...
def parse_args():
    ...
    parser.add_argument("--path", type=str, default="./knowledge-base/mobileandtableau.txt",
                        help="Path to the PDF file to encode.")
    parser.add_argument("--model", type=str, default="DeepSeek-Coder-V2-Lite-Instruct",
                        help="Language model to use (default: DeepSeek-Coder-V2-Lite-Instruct).")
